...
-- Dumping structure for table information_schema.ADMINISTRABLE_ROLE_AUTHORIZATIONS
...
-- Dumping structure for table information_schema.COLUMNS_EXTENSIONS
...
-- Dumping structure for table information_schema.ROLE_COLUMN_GRANTS
...
-- Dumping structure for table information_schema.ROLE_ROUTINE_GRANTS
...
-- Dumping structure for table information_schema.ROLE_TABLE_GRANTS
...
-- Dumping structure for table information_schema.SCHEMATA_EXTENSIONS
...
-- Dumping structure for table information_schema.TABLESPACES_EXTENSIONS
...
-- Dumping structure for table information_schema.TABLES_EXTENSIONS
...
-- Dumping structure for table information_schema.TABLE_CONSTRAINTS_EXTENSIONS
...
-- Dumping structure for table information_schema.USER_ATTRIBUTES
...
-- Dumping database structure for laradminlte
DROP DATABASE IF EXISTS `laradminlte`;
CREATE DATABASE IF NOT EXISTS `laradminlte` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `laradminlte`;

-- Dumping structure for table laradminlte.anggotas
...
-- Dumping structure for table laradminlte.bills
...
-- Dumping structure for table laradminlte.debts
DROP TABLE IF EXISTS `debts`;
CREATE TABLE IF NOT EXISTS `debts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
  `debt_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` date NOT NULL,
  `amount` decimal(10,2) NOT NULL,
  `due_date` date NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
...
-- Dumping structure for table laradminlte.expenses
...
-- Dumping structure for table laradminlte.failed_jobs
DROP TABLE IF EXISTS `failed_jobs`;
CREATE TABLE IF NOT EXISTS `failed_jobs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `uuid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping structure for table laradminlte.incomes
...
-- Dumping structure for table laradminlte.items
...
-- Dumping structure for table laradminlte.migrations
DROP TABLE IF EXISTS `migrations`;
CREATE TABLE IF NOT EXISTS `migrations` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `migration` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping structure for table laradminlte.password_resets
...
-- Dumping structure for table laradminlte.pemasukan
...
-- Dumping structure for table laradminlte.pemasukans
...
-- Dumping structure for table laradminlte.saldos
...
-- Dumping structure for table laradminlte.transaksis
...
-- Dumping structure for table laradminlte.transaksi_details
...
CREATE TABLE IF NOT EXISTS `transaksi_details` (
  ...
  KEY `transaksi_details_item_id_foreign` (`item_id`),
  CONSTRAINT `transaksi_details_item_id_foreign` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`),
...
-- Dumping structure for table laradminlte.users
DROP TABLE IF EXISTS `users`;
CREATE TABLE IF NOT EXISTS `users` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping structure for table mysql.replication_asynchronous_connection_failover
...
-- Dumping structure for table mysql.replication_asynchronous_connection_failover_managed
...
-- Dumping structure for table mysql.replication_group_configuration_version
...
-- Dumping structure for table mysql.replication_group_member_actions
...
-- Dumping structure for table performance_schema.binary_log_transaction_compression_stats
...
-- Dumping structure for table performance_schema.error_log
...
-- Dumping structure for table performance_schema.innodb_redo_log_files
...
-- Dumping structure for table performance_schema.keyring_component_status
...
-- Dumping structure for table performance_schema.processlist
DROP TABLE IF EXISTS `processlist`;
...
-- Dumping structure for table performance_schema.replication_asynchronous_connection_failover
DROP TABLE IF EXISTS `replication_asynchronous_connection_failover`;
CREATE TABLE IF NOT EXISTS `replication_asynchronous_connection_failover` (
  `CHANNEL_NAME` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'The replication channel name that connects source and replica.',
  `HOST` char(255) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL COMMENT 'The source hostname that the replica will attempt to switch over the replication connection to in case of a failure.',
...
-- Dumping structure for table performance_schema.replication_asynchronous_connection_failover_managed
DROP TABLE IF EXISTS `replication_asynchronous_connection_failover_managed`;
CREATE TABLE IF NOT EXISTS `replication_asynchronous_connection_failover_managed` (
  `CHANNEL_NAME` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'The replication channel name that connects source and replica.',
  `MANAGED_NAME` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT 'The name of the source which needs to be managed.',
...
-- Dumping structure for table performance_schema.tls_channel_status
