...
@section('title', 'Koperasi WaSerba | Dashboard')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="card bg-warning">
                            <div class="card-body">
                                <i class="fas fa-users icon-top-right"></i>
                                <h5 class="card-title text-light">Jumlah Anggota</h5>

                                <h5 class="card-text font-weight-bold text-white">{{ $jumlahAnggota }} Orang</h5>
                                <a href="{{ route('anggota.index') }}" class="card-link text-white">Lihat selengkapnya</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                         <div class="card bg-primary">
                            <div class="card-body">
                                <i class="fas fa-box icon-top-right"></i>
                                <h5 class="card-title text-light">Jumlah Barang</h5>

                                <h5 class="card-text font-weight-bold text-white">{{ $jumlahBarang }} Item</h5>
                                <a href="{{ route('barang.index') }}" class="card-link text-white">Lihat selengkapnya</a>
                            </div>
                        </div>
                    </div>
                   ...
                   <div class="col-lg-3 mt-3">
                        <div class="card bg-success">
                            <div class="card-body">
                                ...
                                Rp {{ number_format($saldo->jumlah ?? 0, 0, ',', '.') }}
                                </h5>
                                <a href="{{ route('saldo.index') }}" class="card-link text-white">Lihat selengkapnya</a>
                            </div>
                            </div>
                        </div>
